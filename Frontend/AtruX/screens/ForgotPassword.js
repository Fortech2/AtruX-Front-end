...
return (
  <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
    <View style={styles.container}>
      ...
      <Text style={{fontFamily:'Montserrat_600SemiBold', fontSize:24, color:'#474747', top:'-75%', textAlign:'center'}}>{t('forgotpassword')}</Text>
        ...
        <TouchableOpacity style={styles.loginBtn} 
          onPress={() => {handleLogin}}>
          <Text  style={{fontFamily:'Montserrat_500Medium', fontSize:18, color:'#FFFF'}}>{t('recovery_button')}</Text> 
        </TouchableOpacity>
        </View>
      </View>
